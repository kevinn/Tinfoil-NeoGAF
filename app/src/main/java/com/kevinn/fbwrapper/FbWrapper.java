...
import com.kevinn.fbwrapper.activity.BaseFacebookWebViewActivity;
import com.kevinn.fbwrapper.preferences.FacebookPreferences;
...
public class FbWrapper extends BaseFacebookWebViewActivity {
    ...
    private void setOnClickListeners() {
        ...
        findViewById(R.id.menu_item_jump_to_bottom).setOnClickListener(buttonsListener);
     ...
     * Most preferences will be automatically set for the {@link com.kevinn.fbwrapper.webview.FacebookWebView}.
     */
    ...
    /**
     * Configure this {@link com.kevinn.fbwrapper.webview.FacebookWebView}
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.menu_item_jump_to_top:
                    jumpToTop();
                    break;
                case R.id.menu_item_jump_to_bottom:
                    jumpToBottom();
                    break;
