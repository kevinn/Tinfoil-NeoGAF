...
package com.kevinn.fbwrapper.activity;
...
import com.kevinn.fbwrapper.R;
import com.kevinn.fbwrapper.util.Logger;
import com.kevinn.fbwrapper.util.OrbotHelper;
import com.kevinn.fbwrapper.util.WebViewProxyUtil;
import com.kevinn.fbwrapper.webview.FacebookWebChromeClient;
import com.kevinn.fbwrapper.webview.FacebookWebView;
import com.kevinn.fbwrapper.webview.FacebookWebViewClient;
...
public abstract class BaseFacebookWebViewActivity extends Activity implements
    ...
    protected final static String INIT_URL_MOBILE = "http://m.neogaf.com";
    ...
    /**
     * Set a proxy for the {@link com.kevinn.fbwrapper.webview.FacebookWebView}
     *
    ...
    protected void jumpToBottom() {
        loadNewPage("javascript:window.scrollTo(0,9999999999999999);");
    }
